package com.test.contactsapp.ViewModel
...
import com.test.contactsapp.Network.ApiService
import com.test.contactsapp.Network.RetrofitBuilder
import com.test.contactsapp.Network.RetrofitBuilder.lastFmService
...
class Frag1ViewModel :ViewModel()
{
    ...
    {
        var  inputStream: InputStream = context.assets.open("fakeContacts.json")
